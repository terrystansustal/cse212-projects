public class SimpleQueue {
    public static void Run() {
        ...
        // Defect(s) Found: I didn't find any defects for Test 1
        ...
        value = queue.Dequeue();
        Console.WriteLine(value);
        // Defect(s) Found: I didn't find any defects for Test 2
        ...
        // Defect(s) Found: No defects for this code
    }
    ...
    private void Enqueue(int value) {
        _queue.Add(value); // Instead of _queue.Insert, it should be  _queue.Add
    }
